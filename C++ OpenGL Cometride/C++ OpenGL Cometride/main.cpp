...
void display() {
  ...
  glRotatef(static_cast<GLfloat>(year), 0.0, 1.0, 0.0);
  glTranslatef(2.0, 0.0, 0.0);
  glRotatef(static_cast<GLfloat>(day), 0.0, 1.0, 0.0);
...
void reshape(GLint w, GLint h) {
  ...
  glLoadIdentity();
  gluPerspective(60.0, static_cast<GLfloat>(w) / static_cast<GLfloat>(h), 1.0, 40.0);
