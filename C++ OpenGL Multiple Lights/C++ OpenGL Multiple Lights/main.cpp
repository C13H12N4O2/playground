...
int main(int argc, const char* argv[]) {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    lightingShader.setVec3("DirLight.direction", camera.getFront());
    ...
    for (size_t i = 0; i != 4; ++i) {
      std::string str;
      str = std::string("pointLights[") + static_cast<char>(i + 48) + std::string("].");
      lightingShader.setVec3(str + "position", lightPos[i]);
      ...
      lightingShader.setVec3(str + "ambient", ambientColor);
      lightingShader.setVec3(str + "diffuse", diffuseColor);
      lightingShader.setVec3(str + "specular", glm::vec3(1.0f));
    }
